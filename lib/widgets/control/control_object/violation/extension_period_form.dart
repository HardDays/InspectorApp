        ...
        children: [
          ...
          ProjectAutocomplete<ViolationExtensionReason>(
            ...
            onSuggestionSelected: (reason) => setState(() {
              _extensionReason = reason ?? ViolationExtensionReason(name: '');
            }),
            ...
            validator: (_) => _extensionReason.id == null
                ? 'Основание для продления срока нарушения\nдолжно быть выбрано из выпадающего списка'
                : null,
          ),
          SizedBox(
            height: 20,
